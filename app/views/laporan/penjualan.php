        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <a target="_blank" href="<?php echo BASEURL;?>/laporan/penjualan_pdf" class="btn btn-primary mr-3"><i class="fas fa-print"></i> Print</a>
              <a href="<?php echo BASEURL;?>/laporan/penjualan_export" class="btn btn-success"><i class="fas fa-file-excel"></i> Export</a>
            </ol>
          </div>
        </div>
      </div>
          ...
          <div class="col-sm-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number"><?php echo $data['jumlah_penjualan']?></span>
              </div>
            </div>
          </div>
          <div class="col-sm-3">
